    ...
    return (
      ...
      >
        ...
        <Stack
          ...
          gap={4}
          alignItems="flex-start" // Align items at the start for better layout on small screens
        >
          <Box flex={1} maxWidth={764}>
            <img
              src={propertyDetails.photo}
              alt="property_details-img"
              width="100%" // Use percentage to ensure the image fits the container
            ...
            <Box mt="15px">
              <Stack
                ...
                flexWrap="wrap"
                alignItems="center"
                gap={1} // Reduce the gap between elements for better spacing
              >
                <Typography
                  fontSize={18}
                  fontWeight={500}
              ...
              <Stack
                ...
                justifyContent="space-between"
                alignItems="center"
                gap={2} // Reduce the gap between elements for better spacing
              >
                <Box>
                  <Typography
                    fontSize={22}
          ...
          >
            ...
            >
              ...
              {/* Action Buttons */}
              <Stack width="100%" mt="25px" direction="row" gap={2}>
                <CustomButton
